...
export function PerformanceChart({
  ...
  const isPositive = useMemo(() => {
    ...
    return (chartData.at(-1)?.close ?? 0) >= chartData[0].close;
  }, [chartData]);
  ...
  if (chartData.length === 0 && !isLoading) {
    return (
      <div className="flex h-[220px] w-full items-center justify-center text-gray-400 text-sm">
